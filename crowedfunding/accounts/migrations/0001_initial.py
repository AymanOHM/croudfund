    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_phone', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(message='Egyptian phone number is required', regex='^01[0-2,5]{1}[0-9]{8}$')])),
